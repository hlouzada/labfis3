...
params = cmodel.make_params(Vo=vo,Tal=106e-6*224e3)
...
plt.plot(xs, ys, '-',label=r'$V_o e^{\frac{-t}{RC}}$',linewidth=1.8,color='#adadad',zorder=0)
...
plt.xlabel(r'$t\,(s)$',fontsize=10)
plt.ylabel(r'$log(V)\,(V)$',fontsize=10)
